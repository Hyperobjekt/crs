export default function Svg({ symbol, className, children, ...attrs }) {

	const svgSymbols = {
		LocalSch: <path d="M12 1L24 22H0L12 1Z" />,
		LocalOth: <ellipse cx="12" cy="12" rx="12" ry="12" />,
		State: <rect width="22" height="22" x="1" y="1" strokeWidth="2" />,
